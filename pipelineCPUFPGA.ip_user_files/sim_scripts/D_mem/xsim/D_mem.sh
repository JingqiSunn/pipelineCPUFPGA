...
#
# Script generated by Vivado on Mon May 19 21:31:15 CST 2025
...
#
# Usage        : D_mem.sh
#                D_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                D_mem.sh [-reset_run]
#                D_mem.sh [-reset_log]
#                D_mem.sh [-help]
#
...
# script info
echo -e "D_mem.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./D_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot D_mem xil_defaultlib.D_mem xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb D_mem.wdb xsim.dir libdpi.so)
...
Usage: D_mem.sh [-reset_log]\n\
Usage: D_mem.sh [-keep_index]\n\
