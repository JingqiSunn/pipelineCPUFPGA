...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sjq/Documents/pipelineCPUFPGA/pipelineCPUFPGA.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key I_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc I_mem_simv.daidir vcs_lib c.obj)
