...
#
# Script generated by Vivado on Fri May 23 10:21:33 CST 2025
...
#
# Usage        : I_mem.sh
#                I_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                I_mem.sh [-reset_run]
#                I_mem.sh [-reset_log]
#                I_mem.sh [-help]
#
...
#                script (type 'I_mem.sh -help' for more information).
#
...
# script info
echo -e "I_mem.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./I_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.I_mem xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.I_mem -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sjq/Documents/pipelineCPUFPGA/pipelineCPUFPGA.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log I_mem_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: I_mem.sh [-reset_log]\n\
Usage: I_mem.sh [-keep_index]\n\
